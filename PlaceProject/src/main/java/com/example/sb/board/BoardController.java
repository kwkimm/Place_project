...
//      System.out.println("endBlock : " + endBlock);
	...
	public String boardModify(Model model, @PathVariable("bCode") Long bCode, BoardForm boardForm) {
		...
		SearchPlace pn1 = searchPlaceRepository.findBypCode(boardEntity.getPCode1());
		SearchPlace pn2 = searchPlaceRepository.findBypCode(boardEntity.getPCode2());
		SearchPlace pn3 = searchPlaceRepository.findBypCode(boardEntity.getPCode3());
		
		boardForm.setPName1(pn1.getPlaceName());
		boardForm.setPName2(pn2.getPlaceName());
		boardForm.setPName3(pn3.getPlaceName());
		boardForm.setPcode1(pn1.getPCode());
		boardForm.setPcode2(pn2.getPCode());
		boardForm.setPcode3(pn3.getPCode());
